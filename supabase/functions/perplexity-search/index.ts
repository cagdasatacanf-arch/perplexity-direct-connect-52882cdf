  ...
  try {
    ...
    const response = await fetch('https://api.perplexity.ai/chat/completions', {
      ...
      body: JSON.stringify({
        model,
        messages: [
          { role: 'system', content: 'You are a helpful AI assistant. Provide accurate, well-researched answers with citations when available. Be concise but comprehensive.' },
